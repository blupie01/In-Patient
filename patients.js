    ...
    inPatientDatabase.ref().on("child_added", function(childSnapshot){
        ...
        $(button_key).on("click", function(event) {
            ...
            inPatientDatabase.ref().child(key).once('value').then(function(){
                ...
                var patient_row_1 = $("<div class='row'>");
                ...
                $("#first_patient_row").append(completed_patient_row_1);
                $("#second_patient_row").append(completed_patient_row_2);
                $("#third_patient_row").append(completed_patient_row_3);
                $("#fourth_patient_row").append(completed_patient_row_4);

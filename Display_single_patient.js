...
$(document).ready(function(){
    ...
    inPatientDatabase.ref().on("child_added", function(childSnapshot){
        ...
        console.log(childSnapshot.val().medication);
        ...
        // var button_key = $("<a href='Display_single_patient.html'><button class='patient_button waves-effect waves-teal btn-flat blue-grey'>" + whole_name + "</button></a>").attr("data-key", patient_Database_Key);
